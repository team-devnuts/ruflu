...
class UserUtill {
     companion object {
         ...
         fun getAge(birth : String) : Int {
             ...
             var todayStr = if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
         ...
         fun getDistanceToUser(mLatitude : Double, mLongitude : Double, yLatitude : Double, yLongitude : Double) : Float{
