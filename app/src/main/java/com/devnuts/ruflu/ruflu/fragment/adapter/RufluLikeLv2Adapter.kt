...
class RufluLikeLv2Adapter (
    ...
    fun setTalkClickListener(onItemClickListener: RufluLikeLv2Adapter.OnItemClickListener) {
        this.seLikeLv2TalkClickListener = onItemClickListener
    }

    fun setCancelClickListener(onItemClickListener: RufluLikeLv2Adapter.OnItemClickListener) {
